...
**YOU ARE IN: `tronvercel_ui/polecats/shiny/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/tronvercel_ui/` (rig root) or other directories
...
**Your mail address:** `tronvercel_ui/polecats/shiny`
**Your rig:** tronvercel_ui
**Your Witness:** `tronvercel_ui/witness`
...
| Ask Witness for help | `gt mail send tronvercel_ui/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`tronvercel_ui/witness`) when:
...
```bash
gt mail send tronvercel_ui/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
